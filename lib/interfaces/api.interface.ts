...
export interface APIInterface {
    ...
    mintDftInteractive(options: BaseRequestOptions, address: string, ticker: string, WIF: string, commitTime: number, commitNonce: number, commitScriptPubKey: string): Promise<CommandResultInterface>;
